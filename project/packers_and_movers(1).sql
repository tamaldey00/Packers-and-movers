...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2019 at 12:55 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getbooking` ()  select * from booking$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getusers` ()  SELECT * FROM tblusers$$
...
(1, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', '2018-12-01 08:33:48');
...
CREATE TABLE `booking` (
  ...
  `shipping_to` varchar(100) NOT NULL,
  `user_req` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `booking` (`id`, `name`, `mobile_number`, `shipping_from`, `shipping_to`, `user_req`) VALUES
(1, 'tamal', '900', 'bengalore', 'kolkata', 'nb'),
(2, 'Gupta', '9088464489', 'mumbai', 'ram', 'sbkdfjksfbkf');
...
(2, '456@gmail.com', '2018-12-02 05:48:06'),
(3, 'suvro@gmail.com', '2018-12-02 09:05:30');
...
(10, 'yyy', 'huihd@gmil.com', 'ygywgu', '45678', '4567', 'dytyjgjds', 'msva', 'vsh', '2018-12-02 09:37:18', NULL),
(11, 'Tamal Dey', 'tamaldey@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '1234567', NULL, NULL, NULL, NULL, '2018-12-03 06:48:53', NULL),
(12, 'TAMAL', '12134@GMAIL.COM', '827ccb0eea8a706c4c34a16891f84e7b', '2345678', NULL, NULL, NULL, NULL, '2018-12-04 05:31:56', NULL);

--
-- Triggers `tblusers`
--
DELIMITER $$
CREATE TRIGGER `after_tbluser_insert` AFTER INSERT ON `tblusers` FOR EACH ROW begin 
insert into tblusers_backup values(NEW.id,NEW.FullName,NEW.EmailId,NEW.Password,NEW.ContactNo,NEW.dob,NEW.Address,NEW.City,NEW.Country,NEW.RegDate,NEW.UpdationDate);
end
$$
DELIMITER ;
...
--
-- Dumping data for table `tblusers_backup`
--

INSERT INTO `tblusers_backup` (`id`, `FullName`, `EmailId`, `Password`, `ContactNo`, `dob`, `Address`, `City`, `Country`, `RegDate`, `UpdationDate`) VALUES
(1, 'Anuj Kumar', 'demo@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2147483647', NULL, NULL, NULL, NULL, '2017-06-17 19:59:27', '2017-06-26 21:02:58'),
(2, 'AK', 'anuj@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '8285703354', NULL, NULL, NULL, NULL, '2017-06-17 20:00:49', '2017-06-26 21:03:09'),
(3, 'Anuj Kumar', 'webhostingamigo@gmail.com', 'f09df7868d52e12bba658982dbd79821', '09999857868', '03/02/1990', 'New Delhi', 'New Delhi', 'New Delhi', '2017-06-17 20:01:43', '2017-06-17 21:07:41'),
(4, 'Anuj Kumar', 'test@gmail.com', '5c428d8875d2948607f3e3fe134d71b4', '9999857868', '', 'New Delhi', 'Delhi', 'Delhi', '2017-06-17 20:03:36', '2017-06-26 19:18:14'),
