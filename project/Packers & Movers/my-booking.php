						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label>Name</label>
									<input type="text" class="form-control" placeholder="Enter the name"  id="name1" name="name1">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Mobile Number"  id="name1" name="mobile1">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter The Addresss"  id="name1" name="sf">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter The Addresss"  id="name1" name="st">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<textarea class="form-control" placeholder="Enter Your Requirement"  id="name1" name="rt"></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-4"></div>
							<div class="col-sm-4"><button class="btn btn-primary" name="but1" id="but1">Submit</button></div>
							<div class="col-sm-4"></div>
						</div>
		   </form>
...
$req=$_POST['rt'];
echo $name;
$sql="INSERT INTO `booking` (`id`, `name`, `mobile_number`, `shipping_from`, `shipping_to`, `user_req`) VALUES (NULL, '$name', '$mobile', '$shippingf', '$shippingt', '$req')";
